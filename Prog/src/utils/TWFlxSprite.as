package utils
{
	 ...
	 */
	public class TWFlxSprite extends FlxObject
	{
		/**
		...
		static public const FACING_SIN_UP:int 		= 0;
		static public const FACING_SIN_DOWN:int 	= 0;
		...
		*/
		...
		private function facingToFacingCos():int
		{
			switch(facing)
			{
				case LEFT:	return 		FACING_COS_LEFT;
				case RIGHT:	return 		FACING_COS_RIGHT;
				case UP:	return 		FACING_COS_UPorDOWN;
				case DOWN:	return 		FACING_COS_UPorDOWN;
			}
		}
		...
		private function facingToFacingSin():int
		{
			switch(facing)
			{
				case LEFT:	return 		FACING_SIN_LEFT;
				case RIGHT:	return 		FACING_SIN_RIGHT;
				case UP:	return 		FACING_SIN_UPorDOWN;
				case DOWN:	return 		FACING_SIN_UPorDOWN;
			}
		}
