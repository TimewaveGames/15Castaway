package utils
{
	 ...
	 * - getRectangularDistance [Brizo] 30/8/10
	 */
	...
	public class TWMath
	{
		...
		///		Retorna a " distancia retangular" entre dois pontos. Ou seja, entre a distancia
		///	em x e a distancia em y, retorna a maior
		///		NOTE - Sera que e' mais rapido que getDistanceSqr?
		public static function getRectangularDistance(point1:Point, point2:Point):Number {
